...
export function Button({
    ...
    const baseClasses = 
        "flex items-center justify-center gap-3 rounded md:rounded-md text-xs font-bold md:text-sm md:font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 py-2 px-3 md:px-4 md:py-2";
    ...
    const variantClasses = {
        ...
        destructive: "bg-red-600 text-white hover:ng-red-700",
